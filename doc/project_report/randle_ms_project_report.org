...
The frame_id in the header is the parent frame, as the transform is giving the translation and rotation of child_frame_id in relation to frame_id. 

The jackal relies on a node called /robot_state_publisher
